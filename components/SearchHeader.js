  ...
  return (
    <header className="sticky top-0 bg-white">
        <div className="flex w-full p-6 items-center">
            <Image 
                onClick={() => router.push("/")}
                width="120" height="40" objectFit="contain"
                className="cursor-pointer"
                src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/2f/Google_2015_logo.svg/1920px-Google_2015_logo.svg.png"
            />
            <form className="flex border border-gray-200 rounded-full shadow-md px-6 py-3 ml-10 mr-5 flex-grow mx-w-3xl items-center">
                ...
                <MicrophoneIcon className="h-6 hidden sm:inline-flex text-blue-500 pl-3 border-l-2 border-gray-300 mr-2" />
